...
class MainWindow(QMainWindow):
    ...
    def redraw_logged_in_home(self):
        ...
        self.functional_button.menu().setStyleSheet(
            "QMenu::item {background-color: transparent; padding: 5px; color: #000000;} "
        ...
        self.functional_button.menu().setCursor(
    ...
    def __init__(self):
        ...
        self.hot_news_image.setPixmap(
            QtGui.QPixmap(
                getimage_and_setname(hot_news.get_preview_img(), hot_news.get_id())
            )
        )
        ...
        self.recent_1_image.setStyleSheet(
            "border: 1px solid #000000; border-radius: 5px;"
        )
        ...
        self.recent_2_image.setStyleSheet(
            "border: 1px solid #000000; border-radius: 5px;"
        )
...
class ArticleCard(QFrame):
    def __init__(self, article: list[dict], parent=None):
        ...
        self.article_image.setStyleSheet(
            "border: 1px solid #000000; border-radius: 5px;"
        )
    ...
    def open_article(self) -> None:
        ...
        window.author_name.setText(
            "Author: {}\nDate: {}\nViews: {}".format(
                author.get("name"),
                self.article.get("date"),
                str(self.article.get("viewed")),
            )
        )
