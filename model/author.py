class Author:
    ...
    def get_password(self) -> str:
        return self.__password  # Return the hashed password for comparison
    ...
    def get_publication_history(self) -> list[str]:
        return self.__publication_history

    # Setters
    def set_password(self, password):
        self.__password = password  # Incase change password

    def set_name(self, name):
        self.__name = name  # Incase change real name
