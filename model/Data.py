...
client = pymongo.MongoClient(
    "mongodb+srv://bhhoang:Ilove1000@nanikaclustor.mlolje2.mongodb.net/?retryWrites=true&w=majority"
)
...
for article in article_data["Articles"]:
    ...
    collection.update_one({"_id": author_id}, {"$push": {"publication": article_id}})
